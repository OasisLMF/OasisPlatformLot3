...
from .base import BaseDfEngine, BaseOasisDataframe, BaseOasisSeries, wrap_result
...
class DaskDfEngine(BaseDfEngine):
    ...
    @classmethod
    def read_csv(cls, *args, index=None, index_col=None, nrows=None, dtype=None, **kwargs):
        index_col = index_col or index

        df = cls.module.read_csv(*args, dtype={
            'BITIV': 'float64',
            'CondTag': 'float64',
